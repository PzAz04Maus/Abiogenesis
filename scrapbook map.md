...
> planar graphs are to be drawn in such a way that no edges cross each other.[[Abiogenesis/_AB13 High priority stuff/1 Settings Theory & Fluff/stories/1]](https://en.wikipedia.org/wiki/Planar_graph#cite_note-1)[[2]](https://en.wikipedia.org/wiki/Planar_graph#cite_note-2) Such a drawing is called a **plane graph**, or a **planar embedding** of the graph.
